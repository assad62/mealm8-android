package com.mohammadassad.mealm8.core.data.repository

import com.mohammadassad.mealm8.core.data.api.Meal
...
class MealRepository(
    ...
    suspend fun getCategories(): Result<TheMealDbResponse<List<com.mohammadassad.mealm8.core.data.api.Category>>> {
        return theMealDbApiService.getCategories()
    }
    
    suspend fun filterMealsByCategory(category: String): Result<TheMealDbResponse<List<com.mohammadassad.mealm8.core.data.api.MealSummary>>> {
        return theMealDbApiService.filterMealsByCategory(category)
    }
    
    suspend fun filterMealsByArea(area: String): Result<TheMealDbResponse<List<com.mohammadassad.mealm8.core.data.api.MealSummary>>> {
        return theMealDbApiService.filterMealsByArea(area)
    }
    
    suspend fun filterMealsByIngredient(ingredient: String): Result<TheMealDbResponse<List<com.mohammadassad.mealm8.core.data.api.MealSummary>>> {
        return theMealDbApiService.filterMealsByIngredient(ingredient)
    }
    
    suspend fun getCategoryList(): Result<TheMealDbResponse<List<com.mohammadassad.mealm8.core.data.api.CategoryItem>>> {
